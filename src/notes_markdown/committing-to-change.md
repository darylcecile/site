...
With that said, I’m excited to share that I’ve officially earned the coveted <span className="border border-[#0969da] rounded-full px-1.5 py-0.5 text-[#0969da] text-xs whitespace-nowrap leading-4.5 font-[500]">STAFF</span> badge! I joined [Github](https://github.com) earlier this month as a **Software Engineer III** focusing on Delivery in Developer Experience (DX).
