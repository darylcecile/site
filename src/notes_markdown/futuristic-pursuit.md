...
The plan throughout uni was that i'd move back to London once my degree was over, find a job somewhere there as a software developer, and maybe start a company of my own (on the side). In fact, I was so confident in that plan until recently. Last year, during my time on placement at a company in Nottingham called ERT, [Rizwana](https://rizwanakhan.com) (a dear friend of mine) and I co-founded an initiative called ProjectFunction (find out about it [here](https://projectfunction.io)).
