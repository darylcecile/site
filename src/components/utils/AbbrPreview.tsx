...
export function AbbrPreview(props: AbbrPreviewProps) {
	const fallback = props.link ? (
		<FancyLink
			href={props.link}
	...
	return (
		<Suspense fallback={fallback}>
			<AbbrPreviewInner {...props} />
		</Suspense>
	);
}

async function AbbrPreviewInner(props: AbbrPreviewProps) {
