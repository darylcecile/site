...
import { IndependentEdits } from './kelp/IndependentEdits';
...
const components = { h2: SectionHeading, HandbookEditions, HandbookBranches, SelectedPages, IndependentEdits, PinnedEdition, DistributedArchive };
